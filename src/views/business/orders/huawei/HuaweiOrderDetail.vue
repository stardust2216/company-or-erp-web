<template>
  <div class="page-container">
    <el-page-header @back="$router.back()">
      <template #content>
        <span class="page-header-title">华维硫磺 - 订单详情</span>
      </template>
    </el-page-header>
    ...
    <div v-if="order" class="page-body">
      <div class="toolbar no-print">
        ...
        <el-button @click="router.push({ name: 'HuaweiOrders' })">返回列表</el-button>
      </div>
      ...
      <section class="block">
        ...
        <el-descriptions :column="2" border size="default">
          ...
          <el-descriptions-item label="子公司">华维硫磺</el-descriptions-item>
    ...
    <div v-else class="page-body empty-wrap">
      <el-empty description="未找到该订单（可能已删除）">
        <el-button type="primary" @click="router.push({ name: 'HuaweiOrders' })">返回订单列表</el-button>
      </el-empty>
    </div>
  </div>
</template>
